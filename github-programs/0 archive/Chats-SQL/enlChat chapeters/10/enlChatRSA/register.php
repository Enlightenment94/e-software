        ...
        <div id='console'>
            <div style='margin: 0 auto; width: 200px;'>
                ...
                <form id='reg1' action='request.php' method='get'>
                    ...
                    <div style='margin-top: 5px; margin-bottom: 5px;'>password:</div><div><input type='text' name='p' value='pass1' /></div>
                    <div style='margin-top: 5px; margin-bottom: 5px;'>repassword:</div><div><input type='text' name='rp' value='pass1' /></div>
                    <div style='margin-top: 5px; margin-bottom: 5px;'>RSA:</div><div><input id='rsa1' type='text' name='r' value='rsapass1' /></div>
                    <div style='margin-top: 5px; margin-bottom: 5px;'>reRSA:</div><div><input id='rsa2' type='text' name='r' value='rsapass1' /></div>
                    <div style='margin-top: 5px; margin-bottom: 5px;'>pub_key:</div><div><textarea id='area1' name='pk' form='reg1'></textarea></div>
                    <input class="button-chat button-del" style='width: 100px;' type='submit' name='r' value='register' />
                </form>
            </div>
        </div>
    </div>
