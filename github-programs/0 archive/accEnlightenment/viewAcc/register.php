...
require_once("../sqlAcc/insertNotVerifyUser.php");
require_once("../sqlAcc/checkReg_userExist.php");
require_once("../sqlAcc/checkUserExist.php");
require_once("../sqlAcc/addVerifyUser.php");
require_once("../sqlAcc/verify.php");
