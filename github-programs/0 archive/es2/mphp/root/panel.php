...
?>
    <div id=''>
        <form action='./panel.php' method='get'>
            enls <input type='radio' name='np' value='enls' />
            it <input type='radio' name='np' value='it' />
            programming <input type='radio' name='np' value='programming' />
            linux <input type='radio' name='np' value='linux' />
            php <input type='radio' name='np' value='php' />
            phpT <input type='radio' name='np' value='phpT' />
            mysql <input type='radio' name='np' value='mysql' />
            html <input type='radio' name='np' value='html' />
            css <input type='radio' name='np' value='css' />
            security <input type='radio' name='np' value='security' />
