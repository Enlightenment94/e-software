...
function selectTagsByNoteId($by){
    ...
    if ($conn->connect_error) {
        ...
        $sql = "SELECT distinct tit.tag_id, tt.tag FROM " . $GLOBALS['table'] . " t, " . $GLOBALS['beforeTags']. $GLOBALS['table'] . " tt, " . $GLOBALS['beforeIds'] . $GLOBALS['table'] . " tit WHERE tit.note_id = "  . $by ." and t.note_id = tit.note_id and tt.tag_id =  tit.tag_id";
