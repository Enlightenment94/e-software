...
@keyframes halo2 {
  ...
  50% {
    box-shadow: 0 0 0 20px rgba(148, 0, 211, 0);
  }
  100% {
    box-shadow: 0 0 0 20px rgba(148, 0, 211, 0);
  }
...
<body>
    <div id='head'>
        <center>
            ...
            <div id='webDescription'>"Związki mogące pomóc odbudować umysł."</div>
        </center>
    </div>
    </br>

    <?php
    $GLOBALS["perfix"] = "compounds_";
    ...
    <div id='content'>
        ...
        <div class='post' id='post<?php $el['id'];?>'>
            ...
            <div class='col100'>
                <div style='float: left; width: 25%;' class='title' onclick="show('p<?php echo $el['id']; ?>')" ><?php echo $el['title']; ?></div>
                <div style='float: left; width: 70%;' class='description' id='p<?php echo $el['id']; ?>'><?php echo $el['description']; ?></div>
                <div style='width: 100%;' class='subtitle'><?php echo $el['subtitle']; ?></div>
            </div>
        </div>
        <?php }?>
        </div>
