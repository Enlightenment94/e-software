...
*/
                ...
                if(readTimeArr[i] == ""){
                    ...
                    txt += "<div onclick=\"read(\'" + msgIdArr[i] + "\',\'" + chatName + "\')\" style=' background-color: rgba(205, 205, 205, 0.0); margin: 3px; border-radius: 10px 10px 10px 10px; padding: 5px; text-align: center; padding-top: 15px; hover: color:red; '>click"; 
